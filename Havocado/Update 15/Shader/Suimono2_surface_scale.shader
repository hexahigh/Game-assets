...
SubShader {
 Tags { "IGNOREPROJECTOR" = "true" "QUEUE" = "Geometry+50" "RenderType" = "SuimonoWater" }
 Pass {
  Name "FORWARD"
  Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Geometry+50" "RenderType" = "SuimonoWater" "SHADOWSUPPORT" = "true" }
  Offset -1, 1
  Lighting On
  GpuProgramID 8255
Program "vp" {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Geometry+50" "RenderType" = "SuimonoWater" }
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "ShadowCaster"
  Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "SHADOWCASTER" "QUEUE" = "Geometry+50" "RenderType" = "SuimonoWater" "SHADOWSUPPORT" = "true" }
  Offset -1, 1
  Lighting On
  GpuProgramID 183188
Program "vp" {
