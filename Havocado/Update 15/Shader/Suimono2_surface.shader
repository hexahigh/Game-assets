...
_depthColor ("Tint Color 2", Color) = (0.5,0.5,0.5,1)
...
_UnderwaterColor ("Caustics Color", Color) = (1,1,1,1)
...
_RefractStrength ("Refraction Strength", Range(0, 1)) = 0.5
_EdgeFade ("Edge Fade", Range(0.01, 500)) = 1
_EdgeFoamFade ("Edge Foam Amt", Range(5, 500)) = 1
_foamScale ("Foam Scale", Range(5, 500)) = 1
_ShallowFoamAmt ("Shallow Foam Amt", Range(5, 500)) = 1
_HeightFoamAmt ("Edge Foam Amt", Range(5, 500)) = 1
_HeightFoamHeight ("Height Foam Height", Range(5, 500)) = 1
_HeightFoamSpread ("Height Foam Spread", Range(5, 500)) = 1
_DepthFade ("Depth Fade", Range(0.01, 5)) = 1
_ShallowFade ("Shallow Fade", Range(0.01, 5)) = 1
_RefractFade ("Refract Fade", Range(0.01, 500)) = 1
_CausticsFade ("Caustics Fade", Range(0.01, 500)) = 1
_WaveTex ("Wave Texture", 2D) = "white" { }
_shorelineScale ("Shoreline scale", Float) = 1
_shorelineFrequency ("Shoreline Frequency", Float) = 1
_shorelineSpeed ("Shoreline Speed", Float) = 1
_shorelineHeight ("Shoreline Height", Float) = 1
_Tess ("Tessellation", Float) = 4
_minDist ("TessMin", Range(-180, 0)) = 10
_maxDist ("TessMax", Range(20, 500)) = 25
_suimono_uvx ("uvx1", Float) = 0
_suimono_uvy ("uvy1", Float) = 0
}
SubShader {
 Tags { "IGNOREPROJECTOR" = "true" "QUEUE" = "Geometry" "RenderType" = "SuimonoWater" }
 Pass {
  Name "FORWARD"
  Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Geometry" "RenderType" = "SuimonoWater" "SHADOWSUPPORT" = "true" }
  Lighting On
  GpuProgramID 26645
Program "vp" {
SubProgram "d3d11 " {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Geometry" "RenderType" = "SuimonoWater" }
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "ShadowCaster"
  Tags { "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "SHADOWCASTER" "QUEUE" = "Geometry" "RenderType" = "SuimonoWater" "SHADOWSUPPORT" = "true" }
  Lighting On
  GpuProgramID 133003
Program "vp" {
SubProgram "d3d11 " {
