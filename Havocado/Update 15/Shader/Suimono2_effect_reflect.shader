...
Properties {
_DynReflColor ("Reflection Dynamic", Color) = (1,1,1,0.5)
_ReflDist ("Reflection Distance", Float) = 1000
_ReflBlend ("Reflection Blend", Range(0.003, 0.5)) = 0.01
_ReflectionTex ("Reflection", 2D) = "" { }
}
SubShader {
 Tags { "QUEUE" = "Transparent-301" "RenderType" = "Transparent" }
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE" = "FORWARDBASE" "QUEUE" = "Transparent-301" "RenderType" = "Transparent" }
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  Tags { "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Transparent-301" "RenderType" = "Transparent" }
