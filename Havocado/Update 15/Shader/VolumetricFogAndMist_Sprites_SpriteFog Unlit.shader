...
//
///////////////////////////////////////////
Shader "VolumetricFogAndMist/Sprites/SpriteFog Unlit" {
Properties {
...
"// shader disassembly not supported on DXBC"
 ...
 Pass {
  Name "FORWARD"
  Tags { "DisableBatching" = "LodFading" "IGNOREPROJECTOR" = "true" "LIGHTMODE" = "FORWARDADD" "QUEUE" = "Geometry" "RenderType" = "Opaque" }
